1.       Implement a REST service similar to the one from the Go introduction session (see Code in “Files” of go-training channel), but defining different entity(-ies) of your choice.
